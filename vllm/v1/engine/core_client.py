...
def allocate_stateless_group_ports(parallel_config, new_data_parallel_size: int):
    ...
    total_ports_needed = (num_world_groups + num_dp_groups + num_ep_groups + num_eplb_groups) * 3 + 5
    ...
    new_stateless_eplb_group_port_list = [
        all_ports[i : i + 3] for i in range(start_idx, start_idx + num_eplb_groups * 3, 3)
    ]
