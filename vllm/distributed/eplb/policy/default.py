...
class DefaultEplbPolicy(AbstractEplbPolicy):
    ...
    def rebalance_experts(
        ...
        """
        num_layers, num_logical_experts = weight.shape
        print(f"[STEP 13a - EPLB_FLOW_03] DefaultEplbPolicy.rebalance_experts() | layers={num_layers} | logical_experts={num_logical_experts} | physical_replicas={num_replicas} | groups={num_groups} | nodes={num_nodes} | ranks={num_ranks}")
        weight = weight.float()
