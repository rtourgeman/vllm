...
def scale(host, port, new_dp_size, num_redundant_experts=None):
    ...
    if num_redundant_experts is not None:
        payload["num_redundant_experts"] = num_redundant_experts
...
def main():
    ...
    parser.add_argument(
        "--num-redundant-experts", type=int, default=None, help="Number of redundant experts (optional)",
    )

    args = parser.parse_args()

    success = scale(args.host, args.port, args.new_dp_size, args.num_redundant_experts)
